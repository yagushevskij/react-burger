...
interface IRestorePassRequestAction {
  ...
  export type TRestorePassActions = IRestorePassRequestAction | IRestorePassRequestFailedAction | IRestorePassRequestSuccessAction | ISetInitStateRestorePassAction
