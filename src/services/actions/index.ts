...
import type { TOrdersActions } from './orders-user'
import type { TOrdersAllActions } from './orders-all'
...
export type TAppActions = TAuthActions | TConstructorActions | TIngredientActions | TOrderActions | TOrdersActions | TResetPassActions | TRestorePassActions | TUserActions | TOrdersAllActions
